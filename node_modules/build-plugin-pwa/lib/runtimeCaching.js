    ...
    * */
    {
        urlPattern: function (_a) {
            var url = _a.url;
            var isSameOrigin = self.origin === url.origin;
            return !isSameOrigin && ['.jpg', '.jpeg', '.gif', '.png', '.svg', '.ico', '.webp'].some(function (type) { return url.pathname.endsWith(type); });
        },
    ...
    },
    {
        urlPattern: function (_a) {
            var url = _a.url;
            var isSameOrigin = self.origin === url.origin;
            return !isSameOrigin && ['.eot', '.otf', '.ttc', '.woff', '.woff2', '.font.css'].some(function (type) { return url.pathname.endsWith(type); });
        },
        handler: 'StaleWhileRevalidate',
        options: {
...
//# sourceMappingURL=runtimeCaching.js.map