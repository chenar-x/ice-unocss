...
function normalizePathForLint(id) {
    return path.relative(process.cwd(), id).split(path.sep).join('/');
}
var eslintPlugin = function (options) {
    var include = options.include, exclude = options.exclude, ignoreInitial = options.ignoreInitial;
    var worker;
    var filter = (0, pluginutils_1.createFilter)(include || [
        'src/**/*.js',
        'src/**/*.jsx',
        'src/**/*.ts',
        'src/**/*.tsx',
    ], exclude || /node_modules/);
    var lintFile = function (workerThread, file) {
    ...
    var debounceLintFile = debounce(lintFile, 500);
    return {
        name: 'vite-plugin-eslint-report',
        configureServer: function () {
            // active in dev mode
            // eslint-disable-next-line global-require
            var initMainThread = require('./eslint').default;
