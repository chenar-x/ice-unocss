...
import _Number$isSafeInteger from "@babel/runtime-corejs3/core-js-stable/number/is-safe-integer";
...
const Icon = /*#__PURE__*/React.forwardRef((props, ref) => {
  ...
  const classes = cls("".concat(prefixCls, "-icon"), {
    ...
    [_concatInstanceProperty(_context = "".concat(prefixCls, "-icon-")).call(_context, type)]: Boolean(type)
  }, className);
  const outerStyle = {};

  if (_Number$isSafeInteger(rotate)) {
    outerStyle.transform = "rotate(".concat(rotate, "deg)");
  }

  _Object$assign(outerStyle, style);
...
const convertIcon = (Svg, iconType) => {
  const InnerIcon = /*#__PURE__*/React.forwardRef((props, ref) => /*#__PURE__*/React.createElement(Icon, _Object$assign({
