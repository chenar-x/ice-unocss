...
const addKeys = function addKeys() {
  ...
  const keySet = new _Set(originKeys);
  ...
  _forEachInstanceProperty(willAddKeys).call(willAddKeys, key => key && keySet.add(key));

  return _Array$from(keySet);
};
...
const removeKeys = function removeKeys() {
  ...
  _forEachInstanceProperty(willRemoveKeys).call(willRemoveKeys, key => key && keySet.delete(key));
