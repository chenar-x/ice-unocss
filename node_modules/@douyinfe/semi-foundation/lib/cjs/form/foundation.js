...
class FormFoundation extends _foundation.default {
  ...
  getFieldSetterApi() {
    ...
    const setTouched = (field, isTouched, opts) => {
      const fieldApi = this.fields.get(field) ? this.fields.get(field).fieldApi : undefined; // touched is boolean variable, no need to execu deepClone like setValue
