...
const formatOption = (option, disabledOptions) => {
  ...
  if (disabledOptions && (0, _indexOf.default)(disabledOptions).call(disabledOptions, option) >= 0) {
    disabled = true;
  }
...
function generateOptions(length, disabledOptions, hideDisabledOptions) {
  ...
  for (let value = 0; value < length; value += step) {
    if (!disabledOptions || (0, _indexOf.default)(disabledOptions).call(disabledOptions, value) < 0 || !hideDisabledOptions) {
      arr.push(value);
    }
  }
...
class ComboboxFoundation extends _foundation.default {
  ...
  getDefaultFormatIfNeed() {
    if (this._isInProps('format')) {
      ...
      return _constants.strings.DEFAULT_FROMAT_A;
    } else {
  ...
  disabledHours() {
    ...
    if (use12Hours && (0, _isArray.default)(disabledOptions)) {
      if (this.isAM()) {
        var _context;
        ...
        disabledOptions = (0, _map.default)(disabledOptions).call(disabledOptions, h => h === 12 ? 12 : h - 12);
      }
    }
  ...
  createDateDefault() {
    return new Date((0, _parseInt2.default)(String((0, _now.default)() / DAY), 10) * DAY - 8 * HOUR);
  }
