...
class DatePickerFoundation extends _foundation.default {
  ...
  _parseValue(value) {
    ...
    if ((0, _index.isValidDate)(value)) {
      ...
      dateObj = (0, _parser.compatiableParse)(value, this.getProp('format'), undefined, dateFnsLocale);
  ...
  parseInput() {
    ...
    if (input && input.length) {
      ...
      switch (type) {
        ...
        case 'dateTime':
        case 'month':
          parsedResult = input ? (0, _parser.compatiableParse)(input, formatToken, nowDate, dateFnsLocale) : '';
        ...
        case 'dateTimeRange':
          ...
          parsedResult = values && (0, _reduce.default)(values).call(values, (arr, cur) => {
            const parsedVal = cur && (0, _parser.compatiableParse)(cur, formatToken, nowDate, dateFnsLocale);
