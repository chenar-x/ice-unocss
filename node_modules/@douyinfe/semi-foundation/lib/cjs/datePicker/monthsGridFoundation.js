...
class MonthsGridFoundation extends _foundation.default {
  ...
  initDefaultPickerValue() {
    const defaultPickerValue = (0, _parser.compatiableParse)(this.getProp('defaultPickerValue'));
  ...
  handleDateSelected(day, panelType) {
    ...
    const newSelectedDates = (0, _map.default)(_context4 = [...newSelected]).call(_context4, _dateStr => (0, _parser.compatiableParse)(_dateStr, dateFormat, undefined, dateFnsLocale));
  ...
  _mergeDateAndTime(date, time) {
    ...
    const dateStr = (0, _dateFns.format)((0, _index.isValidDate)(date) ? date : (0, _parser.compatiableParse)(date, _constants.strings.FORMAT_FULL_DATE, undefined, dateFnsLocale), _constants.strings.FORMAT_FULL_DATE);
    const timeStr = (0, _dateFns.format)((0, _index.isValidDate)(time) ? time : (0, _parser.compatiableParse)(time, _constants.strings.FORMAT_TIME_PICKER, undefined, dateFnsLocale), _constants.strings.FORMAT_TIME_PICKER);
    const timeFormat = this.getValidTimeFormat();
    return (0, _parser.compatiableParse)((0, _concat.default)(_context5 = "".concat(dateStr, " ")).call(_context5, timeStr), timeFormat, undefined, dateFnsLocale);
  }
  ...
  handleRangeSelected(day) {
    ...
    if (rangeStart || rangeEnd) {
      const [startDate, endDate] = [(0, _parser.compatiableParse)(rangeStart, dateFormat, undefined, dateFnsLocale), (0, _parser.compatiableParse)(rangeEnd, dateFormat, undefined, dateFnsLocale)];
  ...
  handleTimeChange(newTime, panelType) {
    ...
    if (type === 'dateTimeRange' && destRange) {
      const rangeDate = (0, _parser.compatiableParse)(destRange, dateFormat, undefined, dateFnsLocale);
  ...
  _updateTimeInDateRange(panelType, timeDate) {
    ...
    if (rangeStart && rangeEnd) {
      let startDate = (0, _parser.compatiableParse)(rangeStart, dateFormat, undefined, dateFnsLocale);
      let endDate = (0, _parser.compatiableParse)(rangeEnd, dateFormat, undefined, dateFnsLocale); // console.log('_updateTimeInDateRange()', rangeStart, rangeEnd, startDate, endDate);
