    ...
    if (typeof beforeUpload === 'function') {
      ...
      switch (true) {
        ...
        case buResult && (0, _isPromise.default)(buResult):
          {
            _promise.default.resolve(buResult).then(resloveData => {
              var _context5;

              let newResult = {
                shouldUpload: true
              };
              const typeOfResloveData = (0, _slice.default)(_context5 = Object.prototype.toString.call(resloveData)).call(_context5, 8, -1);

              if (typeOfResloveData === 'Object') {
                newResult = (0, _assign.default)((0, _assign.default)({}, newResult), resloveData);
              }
