...
declare class Tree extends BaseComponent<TreeProps, TreeState> {
    ...
    onNodeDragStart: (e: React.DragEvent<HTMLDivElement>, treeNode: TreeNodeProps) => void;
    onNodeDragEnter: (e: React.DragEvent<HTMLDivElement>, treeNode: TreeNodeProps) => void;
    onNodeDragOver: (e: React.DragEvent<HTMLDivElement>, treeNode: TreeNodeProps) => void;
    onNodeDragLeave: (e: React.DragEvent<HTMLDivElement>, treeNode: TreeNodeProps) => void;
    onNodeDragEnd: (e: React.DragEvent<HTMLDivElement>, treeNode: TreeNodeProps) => void;
    onNodeDrop: (e: React.DragEvent<HTMLDivElement>, treeNode: TreeNodeProps) => void;
