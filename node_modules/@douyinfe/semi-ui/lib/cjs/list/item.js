...
class ListItem extends _react.PureComponent {
  wrapWithGrid(content) {
    ...
    return /*#__PURE__*/_react.default.createElement(_grid.Col, (0, _assign.default)({}, rest), content);
  }
  ...
  render() {
    ...
    const itemCls = (0, _classnames.default)("".concat(prefixCls, "-item"), className);
    const bodyCls = (0, _classnames.default)("".concat(prefixCls, "-item-body"), {
      [(0, _concat.default)(_context = "".concat(prefixCls, "-item-body-")).call(_context, align)]: align
    });
    let body;
