...
class List extends _baseComponent.default {
  ...
  wrapChildren(childrenList, children) {
    ...
    if (grid) {
      ...
      const rowProps = {};
      (0, _forEach.default)(_context = ['align', 'gutter', 'justify', 'type']).call(_context, key => {
        if (key in grid) {
          rowProps[key] = grid[key];
        }
      });
      return /*#__PURE__*/_react.default.createElement(_grid.Row, (0, _assign.default)({
        type: "flex"
  ...
  render() {
    ...
    if (dataSource && dataSource.length) {
      ...
      childrenList = [];
      const items = renderItem ? (0, _map.default)(dataSource).call(dataSource, (item, index) => renderItem(item, index)) : [];
      (0, _forEach.default)(_context3 = _react.default.Children).call(_context3, items, (child, index) => {
