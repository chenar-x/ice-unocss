...
const generateId = (() => {
  ...
  return () => {
    ...
    i += 1;
    return (0, _concat.default)(_context = "".concat(_constants.cssClasses.PREFIX, "-sider-")).call(_context, i);
  };
})();
...
class Sider extends _react.default.PureComponent {
  ...
  componentDidMount() {
    ...
    const matchBpt = (0, _filter.default)(_context2 = (0, _keys.default)(responsiveMap)).call(_context2, item => breakpoint && (0, _indexOf.default)(breakpoint).call(breakpoint, item) !== -1);
    const unRegisters = (0, _map.default)(matchBpt).call(matchBpt, screen => (0, _utils.registerMediaQuery)(responsiveMap[screen], {
      match: () => {
  ...
  componentWillUnmount() {
    ...
    (0, _forEach.default)(_context3 = this.unRegisters).call(_context3, unRegister => unRegister());
