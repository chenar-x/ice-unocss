...
class Basic extends _react.default.PureComponent {
  render() {
    ...
    const classString = (0, _classnames.default)(className, (0, _concat.default)(_context = "".concat(prefixCls, "-")).call(_context, type));
    return /*#__PURE__*/_react.default.createElement(tagName, (0, _assign.default)({
...
class Layout extends _react.default.Component {
    ...
    return {
      ...
      removeSider: id => {
        this.setState(state => {
          ...
          return {
            siders: (0, _filter.default)(_context2 = state.siders).call(_context2, curr => curr !== id)
          };
        });
      }
    };
  ...
  render() {
    ...
    }, /*#__PURE__*/_react.default.createElement(Tag, (0, _assign.default)({
      className: classString
    }, others), children));
  }
