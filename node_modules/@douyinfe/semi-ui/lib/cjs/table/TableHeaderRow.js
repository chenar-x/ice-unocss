...
class TableHeaderRow extends _baseComponent.default {
  ...
  render() {
    ...
    const cells = (0, _map2.default)(row, (cell, cellIndex) => {
      ...
      return /*#__PURE__*/_react.default.createElement(HeaderCell, (0, _assign.default)({}, props, {
        style: cellStyle,
        key: column.key || column.dataIndex || cellIndex
      }));
    });
    return /*#__PURE__*/_react.default.createElement(HeaderRow, (0, _assign.default)({}, rowProps, {
      style: style,
      ref: this.cacheRef
    }), cells);
  }
