...
var _context6 = _interopRequireDefault(require("../locale/context"));
...
class monthCalendar extends _baseComponent.default {
  constructor(props) {
    ...
    this.renderEvents = events => {
      ...
      const list = (0, _map.default)(events).call(events, (event, ind) => {
        ...
        return /*#__PURE__*/_react.default.createElement("li", {
          className: (0, _concat.default)(_context2 = "".concat(_constants.cssClasses.PREFIX, "-event-item ")).call(_context2, _constants.cssClasses.PREFIX, "-event-month"),
    ...
    this.renderCollapsed = (events, itemInfo, listCls, month) => {
      ...
      const remained = (0, _filter.default)(events).call(events, i => Boolean(i)).length - itemLimit;
      ...
      }, (0, _map.default)(events).call(events, item => /*#__PURE__*/_react.default.createElement("li", {
    ...
    this.handleClick = (0, _bind.default)(_context4 = this.handleClick).call(_context4, this);
    this.cardRef = new _map2.default();
  }
    ...
    return (0, _assign.default)((0, _assign.default)({}, super.adapter), {
      ...
      notifyClose: (e, key) => {
        ...
        this.setState(prevState => ({
          showCard: (0, _assign.default)((0, _assign.default)({}, prevState.showCard), updates)
        }));
      ...
      openCard: (key, spacing) => {
        ...
        this.setState(prevState => ({
          showCard: (0, _assign.default)({}, updates)
        }));
      },
  ...
  componentDidUpdate(prevProps, prevState) {
    ...
    const nowEventKeys = (0, _map.default)(_context5 = this.props.events).call(_context5, event => event.key);
  ...
  render() {
    ...
    const monthStyle = (0, _assign.default)({
      height,
      width
    }, style);
    return /*#__PURE__*/_react.default.createElement(_localeConsumer.default, {
...
monthCalendar.contextType = _context6.default;