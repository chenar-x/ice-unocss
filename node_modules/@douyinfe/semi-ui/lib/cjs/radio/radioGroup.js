...
class RadioGroup extends _baseComponent.default {
  ...
  render() {
    ...
    const prefixClsDisplay = (0, _classnames.default)(className, {
      ...
      [(0, _concat.default)(_context = "".concat(prefix, "-")).call(_context, direction)]: direction && !isButtonRadio,
      [(0, _concat.default)(_context2 = "".concat(prefix, "-")).call(_context2, direction, "-default")]: direction && isDefaultRadio,
      [(0, _concat.default)(_context3 = "".concat(prefix, "-")).call(_context3, direction, "-card")]: direction && isCardRadio,
