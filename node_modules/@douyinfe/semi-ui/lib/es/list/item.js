...
export default class ListItem extends PureComponent {
  wrapWithGrid(content) {
    ...
    return /*#__PURE__*/React.createElement(Col, _Object$assign({}, rest), content);
  }
  ...
  render() {
    ...
    const bodyCls = cls("".concat(prefixCls, "-item-body"), {
      [_concatInstanceProperty(_context = "".concat(prefixCls, "-item-body-")).call(_context, align)]: align
    });
    let body;
