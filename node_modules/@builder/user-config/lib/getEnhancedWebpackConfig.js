var FriendlyError = require('@builder/pack/deps/@nuxtjs/friendly-errors-webpack-plugin');
var configWebpack5 = require('./webpack5');
module.exports = function (api, _a) {
    var webpackConfig = _a.webpackConfig;
    var context = api.context;
    var command = context.command, webpack = context.webpack, commandArgs = context.commandArgs, userConfig = context.userConfig;
